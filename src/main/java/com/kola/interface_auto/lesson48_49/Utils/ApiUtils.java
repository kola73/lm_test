...
import com.kola.interface_auto.lesson48_49.pojo.ApiInfo;
...
public class ApiUtils {
    ...
    static {
        // 拿到apiInfo的所有信息，
        List<ApiInfo> apiInfoList = (List<ApiInfo>) ExcelUtils_v7.readExcel("/api_v4.xlsx", 1, ApiInfo.class);
        for (ApiInfo apiInfo : apiInfoList) {
            apiInfoMap.put(apiInfo.getApiId(), apiInfo);
        }
        // 拿到apiDetail的所有信息
        List<ApiDetail> apiDetailList = (List<ApiDetail>) ExcelUtils_v7.readExcel("/api_v4.xlsx", 2, ApiDetail.class);
