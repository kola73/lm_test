package com.kola.interface_auto.lesson53.Utils;

import com.kola.interface_auto.lesson53.pojo.ApiDetail;
import com.kola.interface_auto.lesson53.pojo.ApiInfo;
...
public class ApiUtils {
    ...
    static {
        // 拿到apiInfo的所有信息，
        List<ApiInfo> apiInfoList = (List<ApiInfo>) ExcelUtils_v8.readExcel("/api_v8.xlsx", 1, ApiInfo.class);
        for (ApiInfo apiInfo : apiInfoList) {
            apiInfoMap.put(apiInfo.getApiId(), apiInfo);
        }
        // 拿到apiDetail的所有信息
        List<ApiDetail> apiDetailList = (List<ApiDetail>) ExcelUtils_v8.readExcel("/api_v8.xlsx", 2, ApiDetail.class);
