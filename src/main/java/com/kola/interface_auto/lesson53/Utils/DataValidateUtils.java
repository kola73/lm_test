...
import com.kola.interface_auto.lesson53.pojo.SQLChecker;
import com.kola.interface_auto.lesson53.pojo.ValidateResult;
...
public class DataValidateUtils {
    ...
    public static void preSqlValidate(String caseId, int cellNum, String preCheckSql) {
        ...
        for (SQLChecker sqlChecker : preSql) {
            ...
            // 把结果的值写回excel
            ExcelUtils_v8.addCellData(new CellData(caseId, cellNum, validateResultLists));
        }
