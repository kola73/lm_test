package com.kola.interface_auto.lesson52.testCase;

import com.alibaba.fastjson.JSONObject;
import com.kola.interface_auto.lesson52.Utils.ApiUtils;
import com.kola.interface_auto.lesson52.Utils.DataValidateUtils;
import com.kola.interface_auto.lesson52.Utils.ExcelUtils_v8;
import com.kola.interface_auto.lesson52.Utils.HttpUtils_v5;
import com.kola.interface_auto.lesson52.base.BaseTest_v2;
...
public class TestCase extends BaseTest_v2 {
    ...
    public void testPost(String caseId, String apiId, String requestParams, String expectedResponseData,
        ...
        // 发包
        String results = HttpUtils_v5.request(apiId, url, params);
        ExcelUtils_v8.addCellData(new CellData(caseId, 5, results));
        // 后置验证
