package com.kola.interface_auto.lesson46.testCase;

import com.alibaba.fastjson.JSONObject;
import com.kola.interface_auto.lesson46.Utils.ExcelUtils_v6;
import com.kola.interface_auto.lesson46.Utils.HttpUtils_v4;
import com.kola.interface_auto.lesson46.pojo.ApiDetail;
...
public class TestCase {
    ...
    @DataProvider
    public Object[][] datas() {
        List<Object> objLists = ExcelUtils_v6.readExcel("/api_v4.xlsx", 2, ApiDetail.class);
        // 获得list长度
...
//        System.out.println(results);
        ExcelUtils_v6.writeExcel("target/classes/api_v5.xlsx", 2, caseId, 5, results);
    }
