package com.kola.interface_auto.lesson50.pojo;
...
public class ApiDetail extends ExcelObject {
    ...
    public ApiDetail(String caseId, String apiId, String requestParams, String expectedResponseData, String actualResponseData, String preCheckSQL, String preCheckResult, String afterCheckSQL, String afterCheckResult) {
        this.caseId = caseId;
        this.apiId = apiId;
        this.requestParams = requestParams;
        this.expectedResponseData = expectedResponseData;
